...
<<<<<<< HEAD
  ...
  def words
    [
      ["trek", "trip on top of the mountains"],
      ["race", "We are not walking..."],
      ["newyear", "its time to celebrate 2022"],
      ["beach", "lets take a sun bath"],
      ["rice", "i am too little , white and nice"],
    ]
  end
